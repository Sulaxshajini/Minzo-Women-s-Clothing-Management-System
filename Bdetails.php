    ...
    <div class="container mt-5">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-6 col-12">
          <h6 id="dressNameText">DI MODA Women's Shirt Collar Casual Blouse</h6>
          <p><strong id="dressPrice">LKR 2,290</strong></p>
...
<script>
  ...
  if (dressId === 'Dress1') {
    document.getElementById('dressNameText').textContent = 'DI MODA Womens Shirt Collar Casual Blouse';
    document.getElementById('dressPrice').textContent = 'LKR 2,290';
    document.getElementById('dressImage').src = './images/Blouse01.png';
  } else if (dressId === 'Dress2') {
    document.getElementById('dressNameText').textContent = 'Minzo Womens Casual Blouse';
    document.getElementById('dressPrice').textContent = 'LKR 2,490';
    document.getElementById('dressImage').src = './images/Blouse02.png';
  } else if (dressId === 'Dress3') {
    document.getElementById('dressNameText').textContent = 'HUF & DEE Womens Printed Casual Blouse';
    document.getElementById('dressPrice').textContent = 'LKR 3,200';
    document.getElementById('dressImage').src = './images/Blouse03.png';
  } else if (dressId === 'Dress4') {
    document.getElementById('dressNameText').textContent = 'HUF & DEE Womens Casual Check Shirt Blouse';
    document.getElementById('dressPrice').textContent = 'LKR 4,470';
    document.getElementById('dressImage').src = './images/Blouse04.png';
  } else if (dressId === 'Dress5') {
    document.getElementById('dressNameText').textContent = 'HUF & DEE Womens Casual Check Shirt Blouse';
    document.getElementById('dressPrice').textContent = 'LKR 4,000';
    document.getElementById('dressImage').src = './images/Blouse05.png';
  } else if (dressId === 'Dress6') {
    document.getElementById('dressNameText').textContent = 'HUF & DEE Womens Casual Check Shirt Blouse';
    document.getElementById('dressPrice').textContent = 'LKR 4,500';
    document.getElementById('dressImage').src = './images/Blouse06.png';
  } else if (dressId === 'Dress7') {
    document.getElementById('dressNameText').textContent = 'HUF & DEE Ladies Casual Blouse';
    document.getElementById('dressPrice').textContent = 'LKR 2,490';
    document.getElementById('dressImage').src = './images/Blouse07.png';
  } else if (dressId === 'Dress8') {
    document.getElementById('dressNameText').textContent = 'MONALI Womens Casual Blouse';
    document.getElementById('dressPrice').textContent = 'LKR 2,150';
    document.getElementById('dressImage').src = './images/Blouse08.png';
  } else if (dressId === 'Dress9') {
    document.getElementById('dressNameText').textContent = 'HUF & DEE Womens Casual Blouse';
    document.getElementById('dressPrice').textContent = 'LKR 2,290';
    document.getElementById('dressImage').src = './images/Blouse09.png';
  }
</script>
</body>
